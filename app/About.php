...
class About extends Model
{
  ...
  public $translatable = [
    'one_heading', 'one_text', 'two_heading', 'two_text', 'two_txtone', 'two_txttwo', 'two_txtthree',
    'two_txtfour', 'two_imagetext',  'three_heading', 'three_text', 'three_txtone', 'three_txttwo', 'three_txtthree', 'three_txtfour',
    'three_txtfive', 'three_txtsix', 'four_heading', 'four_text',  'four_txtone', 'four_txttwo', 'five_heading', 'five_text',
    'six_heading', 'six_txtone', 'six_txttwo', 'six_txtthree', 'six_deatilone', 'six_deatiltwo', 'six_deatilthree', 'text_one',
    'text_two', 'text_three'
  ];
  ...
  protected $fillable = [
    ...
    'text_one', 'text_two', 'text_three', 'link_one', 'link_two', 'link_three', 'link_four',
