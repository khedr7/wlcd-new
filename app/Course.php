...
class Course extends Model
{
    ...
    protected $fillable = [
        ...
        'requirement', 'url', 'slug', 'status', 'preview_image', 'type', 'preview_type', 'duration',
        'duration_type', 'instructor_revenue', 'involvement_request', 'refund_policy_id', 'assignment_enable',
        'appointment_enable', 'certificate_enable', 'course_tags', 'level_tags', 'reject_txt', 'drip_enable',
        'institude_id', 'country', 'start_date', 'new_course_mail', 'vr_code', 'vr_hole'
    ];
