...
(function ($) {
  ...
  // Student-view-slider
  $("#instructor-related-course").owlCarousel({
    loop: true,
    items: 4,
    dots: false,
    nav: true,
  ...
  // student-view-slider-course-details
  var owl = $("#student-view-slider-course-details").owlCarousel({
    loop: true,
    items: 1,
    dots: true,
    nav: true,
  ...
  // student-view-slider-related-course-details
  var owl = $("#student-view-slider-related-course-details").owlCarousel({
    loop: true,
    items: 3,
    dots: true,
    nav: true,
