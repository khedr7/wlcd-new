            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-box">{{ __('All Coursereviews') }}</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($course as $cat)
                                        @if ($cat->status == 0)
                                            ...
                                            <tr>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <h4 class="modal-heading">{{ __('Are You Sure') }} ?
                                                                    </h4>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                        <input class="coursereviewfeaturedstatus" type="checkbox"
                                                ...
                                                <td>
                                                    <label class="switch">
                                                        <input class="coursereviewstatus" type="checkbox"
                                                            data-id="{{ $cat->id }}" name="status"
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            @can('course-reviews.edit')
                                                                <a class="dropdown-item"
                                                                    href="{{ url('coursereview/' . $cat->id) }}"><i
