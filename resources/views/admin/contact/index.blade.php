			...
			<div class="col-md-4 col-lg-4">
				<div class="widgetbar">
					@can('contact-us.manage')
						...
						<a href="{{ url('contactreason/create') }}" class="float-right btn btn-primary-rgba mr-2"><i
								class="feather icon-plus mr-2"></i>{{ __('Add Reason') }}</a>
					@endcan
				</div>
			</div>
		@endslot
								...
								<tbody>
									...
									@foreach ($items as $item)
										...
										<tr>
													...
													<div class="modal-dialog modal-sm">
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																<form id="bulk_delete_form" method="post" action="{{ route('contactus.bulk.delete') }}">
																	@csrf
																	@method('POST')
											...
											<td>
												@if (isset($item->reason->reason))
													{{ str_limit($item->reason->reason, $limit = 50, $end = '...') }}
												@endif
											</td>
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
														@can('contact-us.manage')
															<a class="dropdown-item" href="{{ route('usermessage.edit', $item->id) }}"><i
