...
@can(' instructor-pending-payout.manage')
    <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('adminstaticword.PaySelected') }}</button>
@endcan
