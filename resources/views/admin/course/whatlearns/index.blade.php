			...
			<div class="card-header">
				...
				@can('what-learn.create')
					<a data-toggle="modal" data-target="#myModaljj" href="#" class="btn btn-primary-rgba"><i
							class="feather icon-plus mr-2"></i>{{ __('Add What Learn') }}</a>
				@endcan
			</div>
			<div class="card-body">
							...
							@foreach ($whatlearns as $cat)
								<tr>
									...
									<td>
										...
										<input type="checkbox" form="bulk_delete_form1" class="filled-in material-checkbox-input2" name="checked[]"
									...
									<td>{{ strip_tags($cat->getTranslation('detail', Session::get('changed_language'), false)) }}</td>
									<!-- ================================== -->
									<td>
										<label class="switch">
											<input class="slider whatlearn" type="checkbox" data-id="{{ $cat->id }}" name="status"
											...
											<div class="modal-dialog modal-sm">
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<p>{{ __('Do you really want to delete') }} {{ $cat->courses->title }} ?
				...
				<div class="panel panel-sum">
					<div class="modal-body">
						<form id="demo-form2" method="post" action="{{ route('whatlearns.store') }}" data-parsley-validate
							...
							<div class="row">
								<div class="col-md-12">
									<label for="detail_en">{{ __('adminstaticword.English Detail') }}:<sup class="redstar">*</sup></label>
									<textarea required rows="1" name="detail_en" class="form-control"
									 placeholder="{{ __('adminstaticword.English Detail') }}"></textarea>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="col-md-12">
									<label for="detail_ar">{{ __('adminstaticword.Arabic Detail') }}:<sup class="redstar">*</sup></label>
									<textarea required rows="1" name="detail_ar" class="form-control"
									 placeholder="{{ __('adminstaticword.Arabic Detail') }}"></textarea>
								</div>
							</div>
							<br>
