    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-title">{{ __('adminstaticword.Edit') }} {{ __('Question Answer') }}</h5>
        </div>
...
​
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea id="detail" name="question" rows="3" class="form-control" placeholder="Enter Your Question" required >{{$que->question}}</textarea>
              </div>
