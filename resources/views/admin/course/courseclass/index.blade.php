        ...
        <div class="card m-b-30">
            <div class="card-header">
                ...
                @can('course-class.create')
                    ...
                    {{-- <a href="http://www.webdesign-flash.ro/vs/" target="_blank"
                        class="float-right btn btn-primary-rgba mr-2"><i
                            class="feather icon-navigation mr-2"></i>{{ __('Encrypt Link') }}</a> --}}
                @endcan
            </div>
                                ...
                                <tr class="sortable row1" data-id="{{ $cat->id }}">
                                    ...
                                    <td>
                                        <input type="checkbox" form="bulk_delete_form"
                                            class="filled-in material-checkbox-input4" name="checked[]"
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input class="slider" type="checkbox" data-id="{{ $cat->id }}"
                                                ...
                                                onchange="courceclassstatus('{{ $cat->id }}')" />
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input class="slider" type="checkbox" data-id="{{ $cat->id }}"
                                                name="featured" {{ $cat->featured == 1 ? 'checked' : '' }}
                                                onchange="courceclassfeatured('{{ $cat->id }}')" />
                                            <span class="knob"></span>
                                        </label>
                                    </td>
                                    <td>
                                        ...
                                        <div class="modal fade bd-example-modal-sm" id="delete{{ $cat->id }}"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleSmallModalLabel">Delete
                                                        </h5>
                            ...
                            <div class="modal-body">
                                <form enctype="multipart/form-data" id="demo-form2" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label
                                                for="exampleInputDetails">{{ __('adminstaticword.ChapterName') }}:<sup
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 btm-20">
                                            <label for="type">{{ __('adminstaticword.Type') }}:<sup
                                                    class="redstar">*</sup></label>
                                            <select name="type" id="filetype" class="form-control select2"
                                                required>
                                        ...
                                        <div class="col-md-12" id="videoUpload" style="display:none">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="video_upld"
                                                        id="inputGroupFile01"
                                                        aria-describedby="inputGroupFileAddon01">
                                                    <label class="custom-file-label" for="inputGroupFile01">Choose
                                                        file</label>
                                        ...
                                        <div class="col-md-12" id="iframeURLBox" style="display:none">
                                            ...
                                            <input type="text" name="iframe_url"
                                                placeholder="Enter Your Iframe URL" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-12" id="liveclassBox" style="display:none">
                                            ...
                                            <br>
                                            <input type="default-date" id="date_time" name="date_time"
                                                placeholder="dd/mm/yyyy" class="datepicker-here form-control">
                                        </div>
                                        ...
                                        @if ($gsetting->aws_enable == 1)
                                            <div class="col-md-12" id="awsBox" style="display:none">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            name="aws_upload" id="inputGroupFile01"
                                                            aria-describedby="inputGroupFileAddon01">
                                                        <label class="custom-file-label" for="inputGroupFile01">Choose
                                                            file</label>
                                                    </div>
                                        ...
                                        <div class="col-md-12" id="zipUpload" style="display:none">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="uplzip"
                                                        id="inputGroupFile01"
                                                        aria-describedby="inputGroupFileAddon01">
                                                    <label class="custom-file-label" for="inputGroupFile01">Choose
                                                        file</label>
                                        ...
                                        <div class="col-md-12" id="previewUrl">
                                            ...
                                            <div id="document11">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            name="video" id="inputGroupFile01"
                                                            aria-describedby="inputGroupFileAddon01">
                                                        <label class="custom-file-label" for="inputGroupFile01">Choose
                                                            file</label>
                                                    </div>
                                            ...
                                            <div id="document22">
                                                <label for="">Preview {{ __('adminstaticword.URL') }}:
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            - <p class="inline info">eg: pdf files</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label
                                                for="exampleInputDetails">{{ __('adminstaticword.Featured') }}:</label><br>
                                            <label class="switch">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="sub_t[]" id="inputGroupFile01"
                                                                aria-describedby="inputGroupFileAddon01">
                                    ...
                                    @if ($cor->drip_enable == 1)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control js-example-basic-single" id="drip_type2"
                                                    name="drip_type">
                                            ...
                                            <div class="col-md-6" style="display: none;" id="dripdays2">
                                                ...
                                                <input type="number" min="1" class="form-control"
                                                    value="{{ old('drip_days') }}" name="drip_days">
                                                <small class="text-muted"><i class="fa fa-question-circle"></i>
                                                    {{ __('Enter days') }}.</small>
                                            </div>
                                        </div>
                        ...
                        <div class="vimeo-content-alignment">
                            <div id="vimeo-page-content" class="" style="overflow:hidden;">
                                <div class="container-4">
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <form action="" method="post" name="vimeo-yt-search"
                                                id="vimeo-yt-search">
