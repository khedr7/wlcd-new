							...
							@foreach ($courseinclude as $cat)
								...
								<tr>
									<td>
										...
										<input type="checkbox" form="bulk_delete_form1" class="filled-in material-checkbox-input" name="checked[]"
											...
											<div class="modal-dialog modal-sm">
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														<form id="bulk_delete_form1" method="post" action="{{ route('courseinclude.bulk_delete') }}">
															@csrf
															@method('POST')
									...
									<td>
										<label class="switch">
											<input class="slider" type="checkbox" data-id="{{ $cat->id }}" name="status"
												{{ $cat->status == '1' ? 'checked' : '' }} onchange="courceinclude('{{ $cat->id }}')" />
				...
				<div class="panel panel-sum">
					<div class="modal-body">
						<form id="demo-form2" method="post" action="{{ route('courseinclude.store') }}" data-parsley-validate
							...
							<div class="row">
								<div class="col-md-6">
									<label for="exampleInputDetails">{{ __('adminstaticword.English Detail') }}:<sup
											class="redstar">*</sup></label>
									<textarea rows="1" name="detail_en" class="form-control" required
									 placeholder="{{ __('adminstaticword.English Detail') }}"></textarea>
								</div>

								<div class="col-md-6">
									<label for="exampleInputDetails">{{ __('adminstaticword.Arabic Detail') }}:<sup
											class="redstar">*</sup></label>
									<textarea rows="1" name="detail_ar" class="form-control" required
