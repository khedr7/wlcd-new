                ...
                <form action="{{ route('course.update', $cor->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                                ...
                                @if (Auth::user()->role == 'admin')
                                    ...
                                    @foreach ($users as $user)
                                        <option {{ $cor->user_id == $user->id ? 'selected' : '' }}
                                            value="{{ $user->id }}">{{ $user->fname }}</option>
                                    @endforeach
                                @else
                        ...
                        <div class="col-md-4">
                            ...
                            @endphp
                            <label for="exampleInputSlug">{{ __('adminstaticword.SelectLanguage') }}: <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="title" id="exampleInputTitle"
                                value="{{ $cor->getTranslation('title', 'en', false) }}">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="exampleInputDetails">{{ __('adminstaticword.ShortDetail') }}:<sup
                                    class="redstar">*</sup></label>
                            <textarea name="short_detail" rows="3" class="form-control">{!! $cor->getTranslation('short_detail', 'en', false) !!}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="exampleInputDetails">{{ __('adminstaticword.Requirements') }}:<sup
                                    class="redstar">*</sup></label>
                            <textarea name="requirement" rows="3" class="form-control" required>{!! $cor->getTranslation('requirement', 'en', false)  !!}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="exampleInputSlug">{{ __('adminstaticword.VR-code') }}: <sup
                                    class="redstar">*</sup></label>
                            <input type="number" class="form-control" name="vr_code"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control js-example-basic-single" name="level_tags">
                                    ...
                                    <option {{ $cor->level_tags == 'trending' ? 'selected' : '' }} value="trending">
                                        {{ __('Trending') }}</option>

                                    <option {{ $cor->level_tags == 'onsale' ? 'selected' : '' }} value="onsale">
                                        {{ __('Onsale') }}</option>

                                    <option {{ $cor->level_tags == 'bestseller' ? 'selected' : '' }}
                                        value="bestseller">{{ __('Bestseller') }}</option>

                                    <option {{ $cor->level_tags == 'beginner' ? 'selected' : '' }} value="beginner">
                                        {{ __('Beginner') }}</option>

                                    <option {{ $cor->level_tags == 'intermediate' ? 'selected' : '' }}
                                        value="intermediate">{{ __('Intermediate') }}</option>

                                    <option {{ $cor->level_tags == 'expert' ? 'selected' : '' }} value="expert">
                                        {{ __('Expert') }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup
                                    class="redstar">*</sup></label>
                            <textarea id="detail" name="detail" rows="3" class="form-control">{!! $cor->getTranslation('detail', 'en', false) !!}</textarea>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6">
                            ...
                            <select class="select2-multi-select form-control" name="country[]" multiple="multiple">
                                @foreach ($countries as $country)
                                    <option {{ in_array($country->name, $cor->country ?: []) ? 'selected' : '' }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-dark" for="start_date">{{ __('adminstaticword.StartDate') }}:
                                </label>
                                <input value="{{ $cor->start_date }}" type="text" id="start-date"
                                    class="default-date form-control" name="start_date" placeholder="yyyy/mm/dd"
                  ...
                  <div style="{{ $cor->day == 1 ? '' : 'display:none' }}" id="jeet">
                    ...
                    <input type="number" min="1"  class="form-control" name="day" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Enter') }} day" value="{{ $cor->day }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <div style="{{ $cor->type == 1 ? '' : 'display:none' }}" id="doabox">
                                <label for="exampleInputSlug">{{ __('adminstaticword.Price') }}: <sup
                                        class="redstar">*</sup></label>
                                <input step="0.01" type="text" inputmode="numeric"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label
                                    for="exampleInputDetails">{{ __('Instructor InvolvementRequest') }}:</label><br>
                                <label class="switch">
                                    <input class="slider" type="checkbox" id="customSwitch6"
                                        name="involvement_request"
                                        {{ $cor->involvement_request == 1 ? 'checked' : '' }} />
                                    <span class="knob"></span>
                                </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div @if ($cor->preview_type == 'video') class="display-none" @endif id="document2">
                                ...
                                <input type="url" class="form-control"
                                    placeholder="{{ __('adminstaticword.Enter') }} URL" name="url"
                                    id="url" value="{{ $cor->url }}">
                            </div>
                        </div>
                        ...
                        @if (Auth::user()->role == 'instructor')
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="custom-file-input" id="inputGroupFile01"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input required readonly id="image" name="preview_image" type="text"
                                            class="form-control"
                                            value="{{ $cor['preview_image'] != null ? $cor['preview_image'] : '' }}">
                                        <div class="input-group-append">
                                    ...
                                    <small class="text-info"> <i
                                            class="text-dark feather icon-help-circle"></i>({{ __('Choose Image for
                                                                                                                  post') }})</small>
                                    <br>
                            ...
                            @if (Auth::User()->role == 'admin')
                                ...
                                <div class="input-group">
                                    ...
                                    <input min="1" max="100" class="form-control"
                                        name="instructor_revenue" type="number"
                                        value="{{ $cor['instructor_revenue'] }}" id="revenue"
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <label class="switch">
                                <input class="slider" type="checkbox" name="assignment_enable"
                                    {{ $cor['assignment_enable'] == '1' ? 'checked' : '' }} />
                                <span class="knob"></span>
                            </label>
                            <br>
                            <small class="text-info"><i class="fa fa-question-circle"></i>
                        ...
                        <div class="col-sm-3">
                            ...
                            <label class="switch">
                                <input class="slider" type="checkbox" name="appointment_enable"
                                    {{ $cor['appointment_enable'] == '1' ? 'checked' : '' }} />
                                <span class="knob"></span>
                            </label>
                        ...
                        <div class="col-sm-3">
                            ...
                            <label
                                for="exampleInputDetails">{{ __('adminstaticword.CertificateEnable') }}:</label><br>
                            <!--  -->
                            <label class="switch">
                                <input class="slider" type="checkbox" name="certificate_enable" id="customSwitch10"
                                    {{ $cor['certificate_enable'] == '1' ? 'checked' : '' }} />
                                <span class="knob"></span>
                            </label>
