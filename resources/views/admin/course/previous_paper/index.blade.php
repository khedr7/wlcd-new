			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table id="" class="displaytable table table-striped table-bordered w-100">
						<thead>
							<tr>
								<th> <input id="checkboxAll12" type="checkbox" class="filled-in" name="checked[]" value="all" />
						...
						<tbody>
							...
							@foreach ($papers as $paper)
								<tr>
									<?php $i++; ?>
									<td>
										<input type="checkbox" form="bulk_delete_form12" class="filled-in material-checkbox-input12" name="checked[]"
											value="{{ $paper->id }}" id="checkbox{{ $paper->id }}">
										<label for="checkbox{{ $paper->id }}" class="material-checkbox"></label>
										<?php echo $i; ?>
											...
											<div class="modal-dialog modal-sm">
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														<form id="bulk_delete_form12" method="post" action="{{ route('previouspaper.bulk_delete') }}">
															@csrf
															@method('POST')
									...
									<td>{{ $paper->getTranslation('title', Session::get('changed_language'), false) }}</td>
									<td>{{ strip_tags($paper->getTranslation('detail', Session::get('changed_language'), false)) }}</td>
									<td>
										<label class="switch">
											<input class="slider" type="checkbox" data-id="{{ $paper->id }}" name="status"
												{{ $paper->status == 1 ? 'checked' : '' }} onchange="previouspaper('{{ $paper->id }}')" />
					...
					<div class="modal-body">
						...
						<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
							<li class="nav-item">
								<a
									...
									id="pills-english2-tab" data-toggle="pill" href="#pills-english2" role="tab"
									aria-controls="pills-english2" aria-selected="true">{{ __('English') }}</a>
							</li>
							<li class="nav-item">
								<a
									...
									id="pills-arabic2-tab" data-toggle="pill" href="#pills-arabic2" role="tab" aria-controls="pills-arabic2"
						...
						<div class="tab-content" id="pills-tabContent">
							<div
								...
								id="pills-english2" role="tabpanel" aria-labelledby="pills-english2-tab">
								...
								<form id="demo-form2" method="post" action="{{ route('previous-paper.store') }}" data-parsley-validate
									...
									<div class="col-md-12">
										<select class="d-none" name="course_id" class="form-control select2 d-none">
											<option value="{{ $cor->id }}">{{ $cor->getTranslation('title', 'en', false) }}</option>
										</select>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
										...
										<textarea rows="1" name="detail" class="form-control select2" placeholder="Enter Your Detail"></textarea>
									</div>
							...
							<div
								...
								id="pills-arabic2" role="tabpanel" aria-labelledby="pills-arabic2-tab">
								...
								<form id="demo-form2" method="post" action="{{ route('previous-paper.store') }}" data-parsley-validate
									...
									<div class="col-md-12">
										<select class="d-none" name="course_id" class="form-control select2 d-none">
											<option value="{{ $cor->id }}">{{ $cor->getTranslation('title', 'ar', false) }}</option>
										</select>
									</div>
