                        ...
                        <tbody>
                            ...
                            @foreach ($papers as $paper)
                                <tr>
                                    <?php $i++; ?>
                                    <td>
                                        <input type="checkbox" form="bulk_delete_form12"
                                            class="filled-in material-checkbox-input12" name="checked[]"
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input class="slider" type="checkbox" data-id="{{ $paper->id }}"
                                                name="status" {{ $paper->status == 1 ? 'checked' : '' }}
                                                onchange="previouspaper('{{ $paper->id }}')" />
                                    ...
                                    <td>
                                        ...
                                        <!-- delete Modal start -->
                                        <div class="modal fade bd-example-modal-sm" id="deletepaper{{ $paper->id }}"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post"
                                                            action="{{ url('previous-paper/' . $paper->id) }}"
                                                            class="pull-right">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
        ...
        <div class="modal-content">
            ...
            <div class="box box-primary">
                <div class="panel panel-sum">
                    <div class="modal-body">
                        <form id="demo-form2" method="post" action="{{ route('previous-paper.store') }}"
                            ...
                            <div class="col-md-12">
                                <label for="">{{ __('adminstaticword.Title') }}:<sup
                                        class="redstar">*</sup></label>
                                <input type="text" name="title" class="form-control select2" autocomplete="off"
                                    required>
                            </div>
                            <div class="col-md-12">
