                ...
                <div class="card-body">
					<div class="form-group col-md-12">
						<ul class="instructor">
							...
							<li><span class="text-color">{{ __('adminstaticword.Name') }}:</span> {{ $show->fname }} {{ $show['lname'] }}</li>
							<li><span class="text-color">{{ __('adminstaticword.Role') }}:</span> {{ $show->role }}</li>
							<li><span class="text-color">{{ __('adminstaticword.Phone') }}:</span> {{ $show->mobile }}</li>
							<li><span class="text-color">{{ __('adminstaticword.Email') }}:</span> {{ $show->email }}</li>
							<li><span class="text-color">{{ __('adminstaticword.Detail') }}:</span> {{ $show->detail }}</li>
							<li><span class="text-color">{{ __('adminstaticword.Resume') }}:</span> <a href="{{ asset('files/instructor/'.$show->file) }}" download="{{$show->file}}">{{ __('adminstaticword.Download') }} <i class="fa fa-download"></i></a></li>
