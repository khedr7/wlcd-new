            ...
            <div class="card">
              <!-- ========= -->
                ...
                <div class="row align-items-center">
                    <div class="col-md-7">
                    <!-- <div class="card-header">
                        <h5 class="card-title">{{ __('adminstaticword.Language') }}</h5>
                    </div>  -->
                    </div> 
                    <div class="col-md-5">
                    <div class="widgetbar">
                                  ...
                                  <td>
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                              {{-- <a class="dropdown-item" href="{{route('frontstatic.lang', $language->local)}}"><i class="feather icon-edit mr-2"></i>Edit</a> --}}

                                              <a class="dropdown-item" href="{{url('admin/languages/'. $language->local.'/translations')}}"><i class="feather icon-edit mr-2"></i>Edit</a>
                                          </div>
                                      </div>
                                  </td>
