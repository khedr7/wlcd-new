				...
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard">
						<ul class="vertical-menu">
							...
							@canany(['users.view', 'Alluser.view', 'Allinstructor.view'])
								...
								<li
									...
									<a href="javaScript:void();" class="menu"><i class="feather icon-users text-secondary"></i>
										<span>{{ __('Users') }}<div class="sub-menu truncate">All Users, All Students,
												All Instructors</div></span>
										<i class="feather icon-chevron-right"></i>
									</a>
									<ul class="vertical-submenu">
										@can('users.view')
											<li>
												<a class="{{ Nav::isResource('user') }}" href="{{ route('user.index') }}">{{ __('All Users') }}</a>
											</li>
										@endcan
										@can('Alluser.view')
											<li>
							...
							@canany(['instructorrequest.view', 'instructor-pending-request.manage', 'instructor-plan-subscription.view'])
								<li class="{{ Nav::isResource('plan/subscribe/settings') }} {{ Nav::isResource('subscription/plan') }}  {{ Nav::isRoute('all.instructor') }} {{ Nav::isResource('requestinstructor') }}">
									<a href="javaScript:void();" class="menu"><i class="feather icon-user text-secondary"></i>
										<span>{{ __('adminstaticword.Instructors') }}<div class="sub-menu truncate">All
												Instructor Request, Pending Request,
												Multiple Instructor, Instructor Payout</div></span>
										<i class="feather icon-chevron-right"></i>
									</a>
									<ul class="vertical-submenu">
										@can('instructorrequest.view')
											<li class="{{ Nav::isRoute('all.instructor') }}"><a href="{{ route('all.instructor') }}">{{ __('adminstaticword.All') }}
													{{ __('adminstaticword.InstructorRequest') }}</a></li>
										@endcan
										@can('instructor-pending-request.manage')
											<li class="{{ Nav::isResource('requestinstructor') }}"><a href="{{ url('requestinstructor') }}">{{ __('adminstaticword.Pending') }}
													{{ __('Request') }}</a></li>
										@endcan
										...
										<li class="{{ Nav::isRoute('allrequestinvolve') }} {{ Nav::isRoute('involve.request.index') }} {{ Nav::isRoute('involve.request') }}">
											...
											<ul class="vertical-submenu">
												...
												<li class="{{ Nav::isRoute('allrequestinvolve') }}"><a href="{{ route('allrequestinvolve') }}">{{ __('adminstaticword.RequestToInvolve') }}</a>
												</li>
												<li class="{{ Nav::isRoute('involve.request.index') }}"><a href="{{ route('involve.request.index') }}">{{ __('adminstaticword.InvolvementRequests') }}</a>
												</li>
										...
										<li class="{{ Nav::isRoute('instructor.settings') }} {{ Nav::isRoute('admin.instructor') }} {{ Nav::isRoute('admin.completed') }}">
											...
											<ul class="vertical-submenu">
												...
												<li class="{{ Nav::isRoute('admin.instructor') }}"><a href="{{ route('admin.instructor') }}">{{ __('adminstaticword.PendingPayout') }}</a>
												</li>
												<li class="{{ Nav::isRoute('admin.completed') }}"><a href="{{ route('admin.completed') }}">{{ __('adminstaticword.CompletedPayout') }}</a>
												</li>
							...
							<!-- user end -->
							@canany(['categories.view', 'courses.view', 'bundle-courses.view', 'course-languages.view', 'course-reviews.view', 'assignment.view', 'refund-policy.view', 'quiz-review.view', 'private-course.view', 'reported-course.view',
								...
								<li
									...
									<a href="javaScript:void();" class="menu"><i class="feather icon-book text-secondary"></i>
										<span>{{ __('adminstaticword.Course') }}<div class="sub-menu truncate">Categories,
												Courses, Bundle Course, Course Language, Course Review, Assignment, Refund
												Policy, Reported Course, Reported Question</div></span>
										<i class="feather icon-chevron-right"></i>
									</a>
									<ul class="vertical-submenu">
										<!-- Category start  -->
										@canany(['categories.view', 'subcategories.view', 'childcategories.views'])
											<li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }}">
												<a href="javaScript:void();"><span>{{ __('adminstaticword.Category') }}</span><i class="feather icon-chevron-right"></i>
												</a>
												<ul class="vertical-submenu">
													@can(['categories.view'])
														<li class="{{ Nav::isResource('category') }}"><a href="{{ url('category') }}">{{ __('adminstaticword.Category') }}</a>
														</li>
													@endcan
													@can(['subcategories.view'])
														<li class="{{ Nav::isResource('subcategory') }}"><a href="{{ url('subcategory') }}">{{ __('adminstaticword.SubCategory') }}</a>
														</li>
													@endcan
													@can(['childcategories.view'])
														<li class="{{ Nav::isResource('childcategory') }}"><a href="{{ url('childcategory') }}">{{ __('adminstaticword.ChildCategory') }}</a>
														</li>
													@endcan
													{{-- @can(['categories.view'])
														@can(['subcategories.view'])
															<li class="{{ Nav::isRoute('favCategory') }}"><a href="{{ route('favCategory') }}">{{ __('favCategory') }}</a>
															</li>
														@endcan
													@endcan --}}
												</ul>
										...
										<!-- Category end  -->
										@can(['courses.view'])
											<li class="{{ Nav::isResource('course') }}"><a href="{{ url('course') }}"><span>{{ __('adminstaticword.Courses') }}</span></a>
											</li>
										@endcan
										@can(['bundle-courses.view'])
											<li class="{{ Nav::isResource('bundle') }}"><a href="{{ url('bundle') }}"><span>{{ __('adminstaticword.BundleCourse') }}</span></a>
											</li>
										@endcan
										@can(['course-languages.view'])
											<li class="{{ Nav::isResource('courselang') }}"><a href="{{ url('courselang') }}"><span>{{ __('adminstaticword.CourseLanguage') }}</span></a>
											</li>
										@endcan
										@can(['course-reviews.view'])
											<li class="{{ Nav::isResource('coursereview') }}"><a href="{{ url('coursereview') }}"><span>{{ __('adminstaticword.CourseReview') }}</span></a>
											</li>
										@endcan
										@can(['assignment.view'])
											@if ($gsetting->assignment_enable == 1)
												<li class="{{ Nav::isRoute('assignment.view') }}"><a href="{{ route('assignment.view') }}"><span>{{ __('adminstaticword.Assignment') }}</span></a>
												</li>
											@endif
										@endcan
										@can(['refund-policy.view'])
											<li class="{{ Nav::isResource('refundpolicy') }}"><a href="{{ url('refundpolicy') }}"><span>{{ __('adminstaticword.RefundPolicy') }}</span></a>
											</li>
										@endcan
										{{-- @can(['batch.view'])
							...
							@canany(['meetings.zoom-meetings.view', 'meetings.big-blue.view', 'meetings.google-meet.view', 'meetings.jitsi-meet.view', 'meetings.google-classroom.view', 'meetings.meeting-recordings.view'])
								<li
									...
									<a href="javaScript:void();" class="menu"><i class="feather icon-clock text-secondary"></i>
										<span>{{ __('adminstaticword.Meetings') }}<div class="sub-menu truncate">
												Google
												Meet</div></span>
										<i class="feather icon-chevron-right"></i>
									</a>
											...
											<li class="{{ Nav::isRoute('googlemeet.setting') }} {{ Nav::isRoute('googlemeet.index') }} {{ Nav::isRoute('googlemeet.allgooglemeeting') }}">
												...
												<ul class="vertical-submenu">
													...
													<li class="{{ Nav::isRoute('googlemeet.allgooglemeeting') }}">
														<a href="{{ route('googlemeet.allgooglemeeting') }}">{{ __('adminstaticword.AllMeetings') }}</a>
													</li>
							...
							{{-- @can(['affiliate.manage'])
								<li class="{{ Nav::isRoute('save.affiliates') }}">
									<a href="{{ route('save.affiliates') }}" class="menu">
										<i class="feather icon-dollar-sign text-secondary"></i><span>{{ __('adminstaticword.Affiliate') }}</span>
									</a>
								</li>
							@endcan --}}
							{{-- @can(['wallet-transactions.manage'])
                                <li class="{{ Nav::isRoute('wallet.transactions') }}">
                                    <a href="{{ route('wallet.transactions') }}" class="menu">
                                        <i
                                            class="feather icon-dollar-sign text-secondary"></i><span>{{ __('adminstaticword.Transactions') }}</span>
                                    </a>
                                </li>
                            @endcan --}}
							{{-- @canany(['affiliate.manage', ' wallet-setting.manage', 'wallet-transactions.manage'])
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu">
                                        ...
                                        <span>{{ __('adminstaticword.Affiliate&Transactions') }}
                                            <div class="sub-menu truncate">Affiliate, Wallet</div>
                                            <div class="sub-menu truncate">Affiliate, Transactions</div>
                                        </span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
							...
							@canany(['report.progress-report.manage', 'report.revenue-admin-report.manage', 'report.revenue-instructor-report.manage'])
								<li class="{{ Nav::isResource('user/course/report') }} {{ Nav::isResource('user/question/report') }}{{ url('show/progress/report') }} {{ Nav::isResource('show/quiz/report') }}">
									<a href="javaScript:void();" class="menu">
										<i class="feather icon-file-text text-secondary"></i>
										<span>{{ __('adminstaticword.Report') }}<div class="sub-menu truncate">
												Progress Report, Revenue Report, Financial Reports</div></span>
										<i class="feather icon-chevron-right"></i>
									</a>
									<ul class="vertical-submenu">
										...
										<li class="{{ Nav::isRoute('admin.revenue.report') }} {{ Nav::isRoute('instructor.revenue.report') }}{{ Nav::isResource('device-logs') }}">
											<a href="javaScript:void();"><span>{{ __('adminstaticword.Revenue') }}
													{{ __('adminstaticword.Report') }}</span><i class="feather icon-chevron-right"></i>
											</a>
											<ul class="vertical-submenu">

												<li class="{{ Nav::isRoute('admin.revenue.report') }}">
													<a href="{{ route('admin.revenue.report') }}">{{ __('adminstaticword.AdminRevenue') }}</a>
												</li>

												<li class="{{ Nav::isRoute('instructor.revenue.report') }}">
													<a href="{{ route('instructor.revenue.report') }}">{{ __('adminstaticword.InstructorRevenue') }}</a>
												</li>
							...
							@canany(['faq.faq-student.view', 'faq.faq-instructor.view'])
								<li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
									<a href="javaScript:void();" class="menu">
										...
										<span>{{ __('adminstaticword.Faq') }}<div class="sub-menu truncate">Faq
												Student,
												Faq
												Instructor</div></span>
										<i class="feather icon-chevron-right"></i>
							...
							@canany(['locations.country.view', 'locations.state.view', 'locations.city.view'])
								<li class="{{ Nav::isResource('admin/country') }} {{ Nav::isResource('admin/state') }} {{ Nav::isResource('admin/city') }}">
									<a href="javaScript:void();" class="menu"><i class="feather icon-map-pin text-secondary"></i>
										<span>{{ __('Locations') }}<div class="sub-menu truncate">Country, State,
												City
											</div>
										</span>
										<i class="feather icon-chevron-right"></i>
									...
									<ul class="vertical-submenu">
										@can(['locations.country.view'])
											<li class="{{ Nav::isResource('admin/country') }}"><a href="{{ url('admin/country') }}">{{ __('adminstaticword.Country') }}</a>
											</li>
										@endcan
										@can(['locations.state.view'])
											<li class="{{ Nav::isResource('admin/state') }}"><a href="{{ url('admin/state') }}">{{ __('adminstaticword.State') }}</a>
											</li>
										@endcan
										@can(['locations.city.view'])
											<li class="{{ Nav::isResource('admin/city') }}"><a href="{{ url('admin/city') }}">{{ __('adminstaticword.City') }}</a>
											</li>
										@endcan
							...
							@can('contact-us.manage')
								<li class="{{ Nav::isResource('usermessage') }}">
									<a href="{{ url('usermessage') }}" class="menu"><i class="feather icon-phone-call text-secondary"></i><span>{{ __('adminstaticword.ContactUs') }}</span>
									</a>
								</li>
							@endcan
							@can('job.manage')
								...
								<li
									...
									<ul class="vertical-submenu">
										...
										@can(['category-sliders.manage'])
											<li class="{{ Nav::isRoute('category.slider') }}"><a href="{{ route('category.slider') }}"><span>{{ __('adminstaticword.CategorySlider') }}</span></a>
											</li>
										@endcan
							...
							@canany(['payment-setting.manual-payment.view'])
								...
								<li class=" {{ Nav::isResource('manualpayment') }} ">
									...
									<a href="javaScript:void();" class="menu"><i class="feather icon-dollar-sign text-secondary"></i>
										<span>{{ __('Payment Setting') }}<div class="sub-menu truncate">Manual
												Payment
											</div>
										</span>
										<i class="feather icon-chevron-right"></i>
