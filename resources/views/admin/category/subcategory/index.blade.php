                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              ...
                              "
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <label
                                                                                    for="exampleInputTit1e">{{ __('adminstaticword.SubCategory') }}:<span
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <label
                                                                                    for="exampleInputTit1e">{{ __('adminstaticword.Slug') }}:<sup
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <label
                                                                                    for="icon">{{ __('adminstaticword.Icon') }}:<span
                                                                                        class="redstar">*</span></label>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <form id="demo-form2" method="post"
                                                            action="{{ url('subcategory/') }}" data-parsley-validate
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <label
                                                                        for="exampleInputTit1e">{{ __('adminstaticword.Category') }}</label>
                                                                    <select name="category_id"
                                                                        class="form-control select2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label
                                                                        for="exampleInputTit1e">{{ __('adminstaticword.SubCategory') }}:<sup
                                                                            class="redstar">*</sup></label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input pattern="[/^\S*$/]+" type="text"
                                                                        class="form-control" name="slug"
                                                                        id="exampleInputTitle" placeholder="Enter slug"
                                                                        value="">
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input id="status_toggle" type="checkbox"
                                                                    class="custom_toggle" name="status" checked />
