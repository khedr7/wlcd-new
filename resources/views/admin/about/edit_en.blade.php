						...
						<div class="col-md-12">
							...
							<div class="row" style="{{ $data['two_enable'] == 1 ? '' : 'display:none' }}" id="sec_two">
								...
								<div class="col-md-6">
									...
									<input value="{{ $data->getTranslation('two_heading', 'en', false) }}" autofocus name="two_heading" type="text" class="form-control"
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_text">{{ __('Family section Text :') }} <span
											class="text-danger">*</span></label>
									<textarea name="two_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_text', 'en', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_txtone">{{ __('Family section Instructor text One :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('two_txtone', 'en', false) }}" name="two_txtone" type="text" class="form-control"
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_txttwo">{{ __('Family section Instructor text Two :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('two_txttwo', 'en', false) }}" name="two_txttwo" type="text" class="form-control"
										placeholder="Enter Text" />
									<br>
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_txtthree">{{ __('Family section Instructor text Three :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('two_txtthree', 'en', false) }}" name="two_txtthree" type="text" class="form-control"
										placeholder="Enter Text" />
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_txtfour">{{ __('Family section Instructor text Four :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('two_txtfour', 'en', false) }}" name="two_txtfour" type="text" class="form-control"
										placeholder="Enter Text" />
									<br>
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_imagetext">{{ __('Family section Image One Detail :') }} <span
											class="text-danger">*</span></label>
									<textarea name="two_imagetext" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_imagetext', 'en', false) }}</textarea>
									<br>
								</div>
								<div class="col-md-6">
									<label class="text-dark" for="text_one">{{ __('Family section Image Two Detail :') }} <span
											class="text-danger">*</span></label>
									<textarea name="text_one" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('text_one', 'en', false) }}</textarea>
									<br>
								</div>
								<div class="col-md-6">
									<label class="text-dark" for="text_two">{{ __('Family section Image Three Detail :') }} <span
											class="text-danger">*</span></label>
									<textarea name="text_two" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('text_two', 'en', false) }}</textarea>
									<br>
								</div>
								<div class="col-md-6">
									<label class="text-dark" for="text_three">{{ __('Family section Image Four Detail :') }} <span
											class="text-danger">*</span></label>
									<textarea name="text_three" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('text_three', 'en', false) }}</textarea>
									<br>
								</div>
							...
							<div class="row" style="{{ $data['three_enable'] == 1 ? '' : 'display:none' }}" id="sec_three">
								<div class="col-md-6">
									<label class="text-dark" for="three_heading">{{ __('Numbers section Heading :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_heading', 'en', false) }}" autofocus name="three_heading" type="text"
										class="form-control" placeholder="Enter Heading" />
								</div>
								<div class="col-md-6">
									<label class="text-dark" for="three_text">{{ __('Numbers section Text :') }} <span
											class="text-danger">*</span></label>
									<textarea name="three_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('three_text', 'en', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txtone">{{ __('Numbers section text One :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txtone', 'en', false) }}" name="three_txtone" type="text" class="form-control"
										placeholder="Enter Text" />
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txttwo">{{ __('Numbers section text Two :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txttwo', 'en', false) }}" name="three_txttwo" type="text" class="form-control"
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txtthree">{{ __('Numbers section text Three :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txtthree', 'en', false) }}" name="three_txtthree" type="text" class="form-control"
										placeholder="Enter Count Text" />
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txtfour">{{ __('Numbers section text Four :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txtfour', 'en', false) }}" name="three_txtfour" type="text" class="form-control"
										placeholder="Enter Count Text" />
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txtfive">{{ __('Numbers section text Five :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txtfive', 'en', false) }}" name="three_txtfive" type="text" class="form-control"
										placeholder="Enter Count Text" />
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="three_txtsix">{{ __('Numbers section text Six :') }} <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('three_txtsix', 'en', false) }}" name="three_txtsix" type="text" class="form-control"
										placeholder="Enter Count Text" />
								</div>
							...
							<div class="row" style="{{ $data['four_enable'] == 1 ? '' : 'display:none' }}" id="sec_four">
								...
								<div class="col-md-12">
									<label class="text-dark" for="four_text">{{ __('Vision section Text :') }} <span
											class="text-danger">*</span></label>
									<textarea name="four_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('four_text', 'en', false) }}</textarea>
								</div>
							...
							<div class="row" style="{{ $data['six_enable'] == 1 ? '' : 'display:none' }}" id="sec_six">
								<div class="col-md-12">
									<label class="text-dark" for="six_heading">{{ __('Missions section Heading') }} : <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('six_heading', 'en', false) }}" name="six_heading" type="text" class="form-control"
										placeholder="Enter Heading" />
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="six_txtone">{{ __('Missions section Text One') }} : <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('six_txtone', 'en', false) }}" name="six_txtone" type="text" class="form-control"
										placeholder="Enter Text" />
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="six_txttwo">{{ __('Missions section Text Two') }} : <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('six_txttwo', 'en', false) }}" name="six_txttwo" type="text" class="form-control"
										placeholder="Enter Text" />
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="six_txtthree">{{ __('Missions section Text Three ') }}: <span
											class="text-danger">*</span></label>
									<input value="{{ $data->getTranslation('six_txtthree', 'en', false) }}" name="six_txtthree" type="text" class="form-control"
										placeholder="Enter Text" />
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="six_deatilone">{{ __('Missions section Detail one') }} : <span
											class="text-danger">*</span></label>
									<textarea name="six_deatilone" rows="5" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('six_deatilone', 'en', false) }}</textarea>
								</div>

								<div class="col-md-4">
									<label class="text-dark" for="six_deatiltwo">{{ __('Missions section Detail two') }} : <span
											class="text-danger">*</span></label>
									<textarea name="six_deatiltwo" rows="5" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('six_deatiltwo', 'en', false) }}</textarea>
								</div>

								<div class="col-md-4">
									<label class="text-dark" for="six_deatilthree">{{ __('Missions section Detail three') }} : <span
											class="text-danger">*</span></label>
									<textarea name="six_deatilthree" rows="5" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('six_deatilthree', 'en', false) }}</textarea>
									<br>
								</div>
