...
<div class="row mt-5">
	  <div class="col-lg-12">
		...
		<p>{{ session()->get('fail') }}<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		...
		<div class="card m-b-30">
		  ...
		  <div class="card-body">
			...
			<div class="button-list">
                <a href="{{ url('certificate'.'/'.$posts) }}" target="blank" class="btn btn-success-rgba btn-lg btn-block">{{ __('View Certificate') }}</a>
            </div>
