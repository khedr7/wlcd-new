                                    ...
                                    <div class="row">
                                            ...
                                            <div @class(['d-none' => $cor->type == '0']) id="doabox">
                                                <div>
                                                    <label for="exampleInputSlug">{{ __('adminstaticword.Price') }}: <sup
                                                            class="text-danger">*</sup></label>
                                                    <input {{ $cor->type == '1' ? 'required' : '' }} type="number"
                                                        min="1" class="form-control" name="price"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                @if (Auth::User()->role == 'admin')
                                                    <label
                                                        for="exampleInputTit1e">{{ __('adminstaticword.Featured') }}:</label>
                                                    <input id="status" type="checkbox" class="custom_toggle"
                                                        name="featured" {{ $cor->featured == 1 ? 'checked' : '' }} />
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="duration1" type="checkbox" class="custom_toggle"
                                                    name="duration_type"
                                                ...
                                                <div @class(['d-none' => $cor->duration_type == 'd']) id="duration">
                                                    ...
                                                    <input min="1" class="form-control" name="duration"
                                                        type="number" id="duration2" value="{{ $cor->duration }}"
