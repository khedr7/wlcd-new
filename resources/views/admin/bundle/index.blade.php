											...
											<tr>
												...
												<td>
													@if ($cat['preview_image'] !== null && $cat['preview_image'] !== '')
														<img src="images/bundle/<?php echo $cat['preview_image']; ?>" class="img-responsive img-circle" width="150px"
															height="100px">
													@else
												...
												<td>{{ $cat->user['fname'] }} {{ $cat->user['lname'] }}</td>
												<td>{{ $cat->slug }}</td>
												<td>
													<label class="switch">
														...
														<div class="modal-dialog modal-sm">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<p class="text-muted">
																		{{ __('Do you really want to delete this Bundle ? This process cannot be undone') }}.
																	</p>
																</div>
																<div class="modal-footer">
															...
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title" id="exampleStandardModalLabel">
																		{{ $cat->getTranslation('title', Session::get('changed_language'), false) }}</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
									...
									@else
										...
										@foreach ($cors as $cor)
											...
											<tr>
												...
												<td>{{ $cor->getTranslation('title', Session::get('changed_language'), false) }}</td>
												<td>{{ $cor->user['fname'] }} {{ $cor->user['lname'] }}</td>
												<td>{{ $cor->slug }}</td>
												<td>
