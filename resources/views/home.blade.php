                            ...
                            @if (Auth::check())
                                <div class="home-btn mb-3">
                                    <a href="" data-toggle="modal" data-target="#myModalinstructor"
                                        class="btn secondary slug" title="Become an Instructor">Join as Instructor</a>
                                </div>
                            @else
                                <div class="home-btn mb-3">
                                    <a href="{{ route('login') }}" class="btn secondary slug"
                                            ...
                                            <div class="view-block">
                                                ...
                                                <div class="advance-badge">
                                                    @if ($recent_course['level_tags'] == !null)
                                                        <span
                                                            class="badge bg-primary">{{ $recent_course['level_tags'] }}</span>
                                                    @endif
                                                </div>
                                                <div class="view-user-img">
                    ...
                    @foreach ($batches as $batch)
                        @if ($batch->status == 1)
                            <div class="item student-view-block student-view-block-1">
                                        ...
                                        <div class="view-img">
                                            @if ($batch['preview_image'] !== null && $batch['preview_image'] !== '')
                                                <a href="{{ route('batch.detail', $batch->id) }}"><img
                                                        data-src="{{ asset('images/batch/' . $batch['preview_image']) }}"
                                                        alt="course" class="img-fluid owl-lazy"></a>
                                            @else
                                                <a href="{{ route('batch.detail', $batch->id) }}"><img
                                                        data-src="{{ Avatar::create($batch->title)->toBase64() }}"
                                                        alt="course" class="img-fluid owl-lazy"></a>
                                            @endif
                                        </div>
                                        <div class="view-user-img">
                                            ...
                                            @if (optional($batch->user)['user_img'] !== null && optional($batch->user)['user_img'] !== '')
                                                <a href="" title=""><img
                                                        src="{{ asset('images/user_img/' . $batch->user['user_img']) }}"
                                                        class="img-fluid user-img-one" alt=""></a>
                                            @else
                                                <a href="" title=""><img
                                                        src="{{ asset('images/default/user.png') }}"
                                ...
                                <div id="prime-next-item-description-block-5{{ $batch->id }}"
                                    class="prime-description-block">
                                    <div class="prime-description-under-block">
                                        <div class="prime-description-under-block">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-md-6 col-lg-3 mb-3 mb-md-0">
                                <div class="paly-image">
                                    <a href="#">
                                        <img src="{{ asset('images/application/playstore.png') }}"
                                            class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="app-image">
                                    <a href="#">
                                        <img src="{{ asset('images/application/appstore.png') }}"
                                            class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="testimonial-img">
                                        <img data-src="{{ asset('images/testimonial/' . $tes['image']) }}"
                                            alt="blog" class="img-fluid owl-lazy">
                                    </div>
                                </div>
                                ...
                                <i data-feather="share-2"></i>
                                    ...
                                    <span class="tooltiptext">
                                        <div class="instructor-home-social-icon">
                                            <ul>
                                                <li><a href="{{ $inst->fb_url }}"><i
                                                            data-feather="facebook"></i></a></li>
                                                <li><a href="{{ $inst->twitter_url }}"><i
                                                            data-feather="twitter"></i></a></li>
                                                <li><a href="{{ $inst->youtube_url }}"></a><i
                                                        data-feather="youtube"></i></a></li>
                                                <li><a href="{{ $inst->linkedin_url }}"><i
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                    <div class="instructor-button my-3">
                        <a href="{{ route('allinstructor/view') }}" class="btn secondary"
                            title="All Instructor">All Instructor
                        </a>
                    </div>
                </div>
            </div>
