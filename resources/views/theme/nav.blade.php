...
<section id="nav-bar" class="main-content nav-bar-main-block">
    <nav class="main-navigation">
        <div class="row top-menu">
            <div class="container">
                <div class="numbers">
                    <a href="mailto: info@wlcd.sy">info@wlcd.sy</a>
            ...
            <div class="navigation fullscreen-search-block">
                ...
                <div class="logo">
                    @if ($gsetting->logo_type == 'L')
                        ...
                        <a href="{{ url('/') }}"><img src="{{ asset('images/logo/logo w.png') }}"
                                class="img-fluid white" alt="logo"></a>
                        <a href="{{ url('/') }}"><img src="{{ asset('images/logo/logo_green.png') }}"
                                class="img-fluid green" alt="logo"></a>
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    @auth
                        ...
                        <div id="notificationTitle">
                            ...
                            @else
                                <img src="{{ asset('images/default/user.jpg') }}" class="dropdown-user-circle"
                                    alt="">
                            @endif
                            ...
                            <ul>
                                ...
                                @if (Auth::User()->role == 'instructor')
                                    <a target="_blank" href="{{ url('/instructor') }}">
                                        <li><i
                                                data-feather="pie-chart"></i>{{ __('frontstaticword.InstructorDashboard') }}
                                        </li>
                                    </a>
                                @endif
                                ...
                                @if (Auth::User()->role == 'user')
                                    @if ($gsetting->instructor_enable == 1)
                                        <a href="#" data-toggle="modal" data-target="#myModalinstructor"
                                            ...
                                            <li><i
                                                    data-feather="shield"></i>{{ __('frontstaticword.BecomeAnInstructor') }}
                                            </li>
                                        </a>
                                    @endif
                                @endif
                            ...
                            <div class="logo" style="text-align: center;">
                                ...
                                @if ($gsetting->logo_type == 'L')
                                    <a href="{{ url('/') }}"><img src="{{ asset('images/logo/logo w.png') }}"
                                            class="img-fluid white" alt="logo"></a>
                                    <a href="{{ url('/') }}"><img
                                            src="{{ asset('images/logo/logo_green.png') }}" class="img-fluid green"
                                            alt="logo"></a>
                                @else()
                                    <a href="{{ url('/') }}"><b>
                                            <div class="logotext">{{ $gsetting->project_title }}</div>
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12"
                            ...
                            <div class="navigation">
                                <div id="cssmenu">
                                    <ul>
                                        <li><a href="#"
                                                title="Categories">{{ __('frontstaticword.Categories') }}</a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="nav-wishlist">
                                        <ul id="nav">
                                            <li id="notification_li">
                                                <a href="{{ url('send') }}" id="notificationLink"
                                                    title="Notification"><i data-feather="bell"></i></a>
                                                <span class="red-menu-badge red-bg-success">
                                                    {{ Auth()->user()->unreadNotifications->where('type', 'App\Notifications\UserEnroll')->count() }}
                                                </span>
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-2 col-2">
                                    <div class="search search-one" id="search">
                                        <form method="GET" id="searchform" action="{{ route('search') }}">
                                            <div class="search-input-wrap">
                                                <input class="search-input" name="searchTerm"
                                                    placeholder="Search in Site" type="text" id="course_name"
                                                    autocomplete="off" />
                                            </div>
                                            <input class="search-submit" type="submit" id="go" value="">
                                            <div class="icon"><i data-feather="search"></i></div>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open"
                                                ...
                                                <div class="scroll-down">
                                                    ...
                                                    @if (Auth::User()->role == 'admin')
                                                        <a target="_blank" href="{{ url('/admins') }}">
                                                            <li><i
                                                                    data-feather="pie-chart"></i>{{ __('frontstaticword.AdminDashboard') }}
                                                            </li>
                                                        </a>
                                                    @endif
                                                    @if (Auth::User()->role == 'instructor')
                                                    ...
                                                    <a href="{{ route('mycourse.show') }}">
                                                        <li><i
                                                                data-feather="book-open"></i>{{ __('frontstaticword.MyCourses') }}
                                                        </li>
                                                    </a>
                                                    <a href="{{ route('wishlist.show') }}">
                                                        <li><i
                                                                data-feather="heart"></i>{{ __('frontstaticword.MyWishlist') }}
                                                        </li>
                                                    </a>
                                                    <a href="{{ route('purchase.show') }}">
                                                        <li><i
                                                                data-feather="shopping-cart"></i>{{ __('frontstaticword.PurchaseHistory') }}
                                                        </li>
                                                    </a>
                                                    <a href="{{ route('profile.show', Auth::User()->id) }}">
                                                        <li><i
                                                                data-feather="user"></i>{{ __('frontstaticword.UserProfile') }}
                                                        </li>
                                                    </a>
                                                    @if (Auth::User()->role == 'user')
                                                        @if ($gsetting->instructor_enable == 1)
                                                    ...
                                                    @if (env('ENABLE_INSTRUCTOR_SUBS_SYSTEM') == 1)
                                                        @if (Auth::User()->role == 'instructor')
                                                            <a href="{{ route('plan.page') }}">
                                                                <li><i
                                                                        data-feather="tag"></i>{{ __('frontstaticword.InstructorPlan') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @if (Auth::User()->role == 'user' || Auth::User()->role == 'instructor')
                                                        @if ($gsetting->device_control == 1)
                                                            <a href="{{ route('active.courses') }}" title="Watchlist">
                                                                <li><i
                                                                        data-feather="framer"></i>{{ __('frontstaticword.Watchlist') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @if ($gsetting->donation_enable == 1)
                                                        <a target="__blank" href="{{ $gsetting->donation_link }}"
                                                            title="Donation">
                                                            <li><i
                                                                    data-feather="framer"></i>{{ __('frontstaticword.Donation') }}
                                                            </li>
                                                        </a>
                                                    @endif
                                                    ...
                                                    @if (Schema::hasTable('affiliate') && Schema::hasTable('wallet_settings'))
                                                        @if (isset($wallet_settings) && $wallet_settings->status == 1)
                                                            <a href="{{ url('/wallet') }}">
                                                                <li><i
                                                                        class="icon-wallet icons"></i>{{ __('frontstaticword.MyWallet') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                        ...
                                                        @if (isset($affiliate) && $affiliate->status == 1)
                                                            <a href="{{ route('get.affiliate') }}">
                                                                <li><i
                                                                        data-feather="users"></i>{{ __('frontstaticword.Affiliate') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                    @endif
                                                    ...
                                                    <a href="{{ route('my.leaderboard') }}">
                                                        <li><i
                                                                class="icon-chart icons"></i>{{ __('frontstaticword.MyLeaderboard') }}
                                                        </li>
                                                    </a>
                                                    @if (Auth::User()->role == 'user')
                                                        <a href="{{ route('studentprofile') }}">
