        ...
        <div class="container">
            <div class="login-signup">
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-6 col-sm-12 register-image">
                            ...
                            <div class="signup-block">
                                <form class="signup-form" method="POST" action="{{ route('register') }}">
                                            ...
                                            <label class="form-check-label" for="term">
                                                <div class="signin-link text-center btm-20">
                                                    <b>{{ __('I agree to ') }}<a href="{{ url('terms_condition') }}"
                                                            title="Policy">{{ __('frontstaticword.Terms&Condition') }}
                                                        </a>, <a href="{{ url('privacy_policy') }}"
                                    ...
                                    <button type="submit" title="Sign Up"
                                        class="btn btn-primary">{{ __('frontstaticword.Signup') }}</button>
                                ...
                                <div class="sign-up text-center">{{ __('frontstaticword.Alreadyhaveanaccount') }}?<a
                                        href="{{ route('login') }}" title="sign-up">
