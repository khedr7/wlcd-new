	                ...
	                <div class="dashboard-items">
	                    <ul>
							...
							<li>
								...
								<a href="#" title="{{ __('My Quizzes') }}">{{ __('My Quizzes') }}</a>
							</li>
	                        <li>
								<i class="fa fa-graduation-cap"></i>
								<a href="#" title="{{ __('My Certificates') }}">{{ __('My Certificates') }}</a>
							</li>
	                        <li>
	                                    ...
	                                    <div class="row">
	                                        <div class="col-lg-2 col-2">
	                                            <div class="profile-update-icon">
	                                                <div class="product-update-social-icons"><a href="{{ $orders->fb_url }}" target="_blank" title="{{ __('facebook')}}"><i class="fa fa-facebook facebook"></i></a>
	                                                </div>
	                                            </div>
	                                        </div>
