                                        ...
                                        <ul>
                                            ...
                                            @if ($cart->discount_price == !null)
                                                <li class="checkout-course-price">
                                                    <b>{{ currency($cart->discount_price, $from = $currency->code, $to = $currency->code, $format = true) }}</b>
                                                    <s>{{ currency($cart->price, $from = $currency->code, $to = $currency->code, $format = true) }}
                                                    </s>
                                                </li>
                                            @else
                                                <li class="checkout-course-price">
                                                    <b>{{ currency($cart->price, $from = $currency->code, $to = $currency->code, $format = true) }}</b>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <h1 class="checkout-total">
                                        {{ __('Total') }}:{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($cart_total, $from = $currency->code, $to = $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}
                                    </h1>
                                </li>

                                <li>
                                    <div class="checkout-price">
                                        <s>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($price_total, $from = $currency->code, $to = $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</s>
                                    </div>
                                </li>
                                    ...
                                    @if ($gsetting->enable_moli == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='mpay'>
                                                        <input type='radio' id='mpay' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#moli_pay"></a>
                                            ...
                                            <div id="moli_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        <form action="{{ route('moli.pay') }}" method="POST"
                                                            autocomplete="off">
                                                            @csrf
                                    ...
                                    @if ($gsetting->enable_skrill == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='skpay'>
                                                        <input type='radio' id='skpay' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#sk_pay"></a>

                                                        <img src="{{ url('images/payment/skrill.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="sk_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        <form action="{{ route('skrill.pay') }}" method="POST"
                                                            autocomplete="off">
                                                            @csrf
                                    ...
                                    @if ($gsetting->enable_rave == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='rpay'>
                                                        <input type='radio' id='rpay' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#rave_pay"></a>
                                            ...
                                            <div id="rave_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        ...
                                                        <form method="POST" action="{{ route('flutterrave.pay') }}"
                                                            id="paymentForm">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="amount"
                                    ...
                                    @if ($gsetting->enable_payhere == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingten">
                                                <div class="panel-title">
                                                    <label for='payhere'>
                                                        <input type='radio' id='payhere' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#payhere_pay"></a>


                                                        <img src="{{ url('images/payment/payhere.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    @if ($gsetting->iyzico_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headinggodvf">
                                                <div class="panel-title">
                                                    <label for='izyy'>
                                                        <input type='radio' id='izyy' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#izyy_pay"></a>


                                                        <img src="{{ url('images/payment/iyzico.png') }}"
                                                            class="img-fluid" alt="iyzipay">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="izyy_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        ...
                                                        <form action="{{ route('izy.pay') }}" method="POST"
                                                            autocomplete="off">
                                                            @csrf
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="email"
                                                                            class="form-control" value="email@email.com"
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="mobile"
                                                                            class="form-control" value="+905350000000"
                                                                            placeholder="+905350000000" required
                                                                            autocomplete="off">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="identity_number"
                                                                            class="form-control" value="74300864791"
                                                                            placeholder="74300864791" required
                                                                            autocomplete="off">
                                    ...
                                    @if ($gsetting->ssl_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingssl">
                                                <div class="panel-title">
                                                    <label for='ssl'>
                                                        <input type='radio' id='ssl' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#ssl_pay"></a>
                                            ...
                                            <div class="card-header" id="headingManual{{ $manual->id }}">
                                                <h2 class="mb-0">
                                                    <button class="btn btn-link" type="button" data-toggle="collapse"
                                                        data-target="#collapseManual{{ $manual->id }}"
                                    ...
                                    @if ($gsetting->aamarpay_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingaamar">
                                                <div class="panel-title">
                                                    <label for='aamar'>
                                                        <input type='radio' id='aamar' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#aamar_pay"></a>


                                                        <img src="{{ url('images/payment/aamarpay.png') }}"
                                                            class="img-fluid" alt="aamarpay">
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    @if ($gsetting->braintree_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingFive">
                                                <div class="panel-title">
                                                    <label for='r15'>
                                                        <input type='radio' id='r15' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#collapseFive"></a>
                                                        <img src="{{ url('images/payment/braintree.png') }}"
                                                            style="margin-left: 15px;" height="30px" width="90px"
                                    ...
                                    @if (isset($wallet_settings) && $wallet_settings->status == 1)
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingWallet">
                                                <div class="panel-title">
                                                    <label for='wallet'>
                                                        <input type='radio' id='wallet' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            ...
                                                            @if (auth()->user()->wallet->status == 1)
                                                                @if (round(auth()->user()->wallet->balance) >= sprintf('%.2f', Crypt::decrypt(strip_tags($secureamount))))
                                                                    <form method="post" id="payment-form"
                                                                        ...
                                                                        <input id="nonce" name="amount"
                                                                            type="hidden"
                                                                            value="{{ strip_tags($secureamount) }}" />
                                    ...
                                    @if ($gsetting->payflexi_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='payflexi'>
                                                        <input type='radio' id='payflexi' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#payflexi_pay"></a>

                                                        <img src="{{ url('images/payment/payflexi.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="payflexi_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        ...
                                                        <form method="POST" action="{{ route('payflexi.pay') }}"
                                                            id="paymentForm">
                                                            {{ csrf_field() }}
