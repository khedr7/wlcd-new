    ...
    Route::middleware(['web'])->group(function () {
        ...
        Route::middleware(['IsInstalled', 'switch_languages', 'ip_block'])->group(function () {
            ...
            Route::middleware(['admin_instructor', 'IsInstalled', 'auth'])->group(function () {
                ...
                Route::get('fav-category', 'FavCategoryController@index')->name('favCategory');
                ...
                Route::get('/admin/import/quiz/{id}', 'QuizController@importquiz')->name('import.quiz');
                ...
                Route::get('show/quiz-answers/{quiz_id?}/{user_id?}', 'QuizController@userAnswers')->name('quiz.userAnswers');
        ...
        Route::middleware(['is_verified', '2fa', 'maintanance_mode', 'switch_languages'])->group(function () {
            ...
            // notifiactaions
            Route::get('notifications-clear-all', 'NewNotificationController@dalateAll')->name('notifications.deleteAll');
            Route::delete('clear-notifications/{id}', 'NewNotificationController@deleteNotification')->name('notifications.delete');
            Route::get('change-notifications-status', 'NewNotificationController@editNotificationsStatus')->name('notifications.read');
